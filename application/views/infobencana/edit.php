                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" name="nama_bencana" class="form-control" placeholder="Nama info bencana" value="<?= $infobencana['nama_bencana'] ?>">
                          ...
                          <div class="form-group">
                            <select name="kota_id" id="kota" class="form-control">
                                ...
                                <?php foreach($kota as $data) : ?>
                                    <option value="<?php echo $data['id']?>" <?php if($data['id'] == $infobencana['kota_id']) echo 'selected' ?>> <?php echo $data['name'] ?></option>
                                <?php endforeach;?>
                            </select>
                          ...
                          <div class="form-group">
                            <select name="kecamatan_id" id="kecamatan" class="form-control">
                                ...
                                <?php foreach($kecamatan as $data) : ?>
                                    <option value="<?php echo $data['id']?>" <?php if($data['id'] == $infobencana['kecamatan_id']) echo 'selected' ?>> <?php echo $data['name'] ?></option>
                                <?php endforeach;?>
                            </select>
                          ...
                          <div class="form-group">
                            <select name="desa_id" id="desa" class="form-control">
                                ...
                                <?php foreach($desa as $data) : ?>
                                    <option value="<?php echo $data['id']?>" <?php if($data['id'] == $infobencana['desa_id']) echo 'selected' ?>> <?php echo $data['name'] ?></option>
                                <?php endforeach;?>
                            </select>
                    ...
                    <div class="col-md-12" id="logistik_wrapper">
                      <label>Kebutuhan Logistik</label>
                        <?php 
                            $nama_logistik = explode(',', $data['nama_logistik']);
                            $jenis_logistik = explode(',', $data['jenis_logistik']);
                            $jumlah_logistik = explode(',', $data['jumlah_logistik']);
                        ?>

                        <?php foreach($nama_logistik as $key => $nama_logistik) {

                              echo $nama_logistik.': '.$jumlah_logistik[$key].'<br>';
                            }
