                ...
                <form action="<?= base_url('users/store') ?>" method="post" enctype="multipart/form-data">
                  <div class="row">
                    ...
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                        ...
                        <input type="email" name="email" class="form-control" placeholder="Email" <?php echo set_value("email"); ?>>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                        ...
                        <input type="number" name="no_hp" class="form-control" <?php echo set_value("no_hp"); ?> placeholder="Nomor Handphone" >
                  ...
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" name="username" class="form-control" <?php echo set_value("username"); ?> placeholder="Username">
                    ...
                    <div class="col-md-4 pl-1 pr-1">
                      <div class="form-group">
                        ...
                        <input type="password" name="password" class="form-control"  <?php echo set_value("password"); ?> placeholder="Password">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Alamat</label>
                        <textarea name="alamat" placeholder="Alamat lengkap" class="form-control textarea"><?php echo set_value("password"); ?></textarea>
