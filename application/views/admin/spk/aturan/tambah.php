         ...
         <div class="row">
            <div class="col-md-6">
                <div class="card shadow mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                        <h6 class="font-weight-bold text-primary">Tambah Aturan</h6>
                        </div>
                    </div>
                    </div>
                    <div class="card-body">            
                        <form action="<?= base_url('admin/spk/prioritas/save_aturan') ?>" method="post">
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12 mt-5">
                                <div class="float-right">
                                    ...
                                    <button type="submit" class="btn btn-success pr-5 pl-5">Tambah</button>
                                </div>
                            </div>
                        </div>
                        </form>
